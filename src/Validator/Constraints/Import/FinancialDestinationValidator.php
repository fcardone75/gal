...
class FinancialDestinationValidator extends ConstraintValidator
{
    use GetterMethod;
    ...
    /**
     * FinancialDestinationValidator constructor.
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$constraint instanceof FinancialDestination) {
            throw new UnexpectedTypeException($constraint, __NAMESPACE__ . '\FinancialDestination');
        }
        ...
        foreach ($constraint->properties as $property) {
            ...
            $existing = $this->entityManager->getRepository(\App\Entity\FinancialDestination::class)->findOneBy([
