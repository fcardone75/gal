...
class LegalFormValidator extends ConstraintValidator
{
    use GetterMethod;
    ...
    /**
     * LegalFormValidator constructor.
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$constraint instanceof LegalForm) {
            throw new UnexpectedTypeException($constraint, __NAMESPACE__ . '\LegalForm');
        }
        ...
        foreach ($constraint->properties as $property) {
            ...
            $existing = $this->entityManager->getRepository(\App\Entity\LegalForm::class)->findOneBy([
                'name' => $propertyValue,
