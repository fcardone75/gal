...
class LeasingDestinationValidator extends ConstraintValidator
{
    use GetterMethod;
    ...
    /**
     * LeasingDestinationValidator constructor.
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$constraint instanceof LeasingDestination) {
            throw new UnexpectedTypeException($constraint, __NAMESPACE__ . '\LeasingDestination');
        }
        ...
        foreach ($constraint->properties as $property) {
            ...
            $existing = $this->entityManager->getRepository(\App\Entity\LeasingDestination::class)->findOneBy([
